$(document).ready(function(){
    ...
    btn.click(function(){
        let value = `
                   <li>
                       <input type="hidden" >
                       <span onclick="changeType(this)" class="newitem">${inp.val()}</span>
                        <button onclick="updateEle(this)" class="fas fa-edit edit"></button>
                       <button onclick="deleteEle(this)" class="fas fa-trash-alt delete"></button>
                   </li>`;
        todoList.push(value);
        result.append(value);
    })
